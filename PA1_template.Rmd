...
```
On average across all the days in the dataset, interval **`r int_mx`** contains the maximum number of steps 
...
```
The mean total number of steps taken per day is **`r mn`** for the raw data and **`r mn1`** for the imputed data.  
The median total number of steps taken per day is **`r md`** for the raw data and **`r md1`** for the imputed data.  
...
**Conclusion**: Differences in activity patterns between weekdays and weekends could be observed according to the panel plot.
